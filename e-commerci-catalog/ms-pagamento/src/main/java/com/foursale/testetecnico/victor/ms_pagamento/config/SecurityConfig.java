...
import com.foursale.testetecnico.victor.ms_pagamento.boundary.security.TokenFilter;
    ...
    SecurityFilterChain security(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(registry -> {
                    ...
                    registry.requestMatchers(HttpMethod.POST, "/v1/pagamento/**").hasRole("usuario");
