...
public class CriarProdutoUserCase {
    ...
    public void criar(Produto produto) throws CriarProdutoValidatiorException, EnviarProdutoException {
        ...
        enviarMensagemProduto.enviar(produto, OperacaoProduto.CRIACAO);

        log.info("Enviando mensagem criar estoque");
        enviarMensagemEstoque.enviar(produto, OperacaoEstoque.CRIAR);
    }
}
